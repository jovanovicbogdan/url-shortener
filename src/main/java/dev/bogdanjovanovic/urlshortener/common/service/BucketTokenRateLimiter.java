...
import dev.bogdanjovanovic.urlshortener.shortener.infrastructure.RedisAofService;
...
public class BucketTokenRateLimiter {
  ...
  private final RedisAofService redisAofService;

  public BucketTokenRateLimiter(
      @Qualifier("redisAofService") final RedisAofService redisAofService) {
    this.redisAofService = redisAofService;
  }
  ...
  public boolean isAllowed(@NonNull final String ip) {
    ...
    final var res = redisAofService.multi((tx) -> {
