...
the probability for collisions and ensuring `62^6` possible combinations. If however collision
...
- [ ] Add rate limiter
- [ ] As an addition to Base62, hash original url first with e.g. MurmurHash or CRC
- [x] ~~Reduce the number of characters, see how goo.gl did it or bit.ly, e.g. tinyurl uses 8 chars~~
- [ ] Add URL alias and expiration
